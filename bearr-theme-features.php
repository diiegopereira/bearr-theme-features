 ...
 * King Composer
 */
function bearr_kingcomposer_admin_js($hook) {
    wp_enqueue_script( 'bearr-kingcomposer-admin-js', plugins_url('/js/custom/bearr-admin-kingcomposer.js', __FILE__) );
    wp_enqueue_style( 'bearr-kingcomposer-admin-css', plugins_url('/css/bearr-admin-kingcomposer.css', __FILE__) );
}
 add_action( 'admin_enqueue_scripts', 'bearr_kingcomposer_admin_js' );
/*
 * BeaRR: Slideshow
 */
