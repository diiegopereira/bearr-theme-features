...
function law_and_justice_tb_slider($atts, $content = null) {
	...
	wp_enqueue_script( 'custom-slider-js', get_template_directory_uri() . '/js/custom/custom-slider.js', array('jquery'), '20151215', true );
...
function law_and_justice_tb_testimonials($atts, $content = null) {
	...
	wp_enqueue_script( 'custom-testimonials-js', get_template_directory_uri() . '/js/custom/custom-testimonials.js', array('jquery'), '20151215', true );
...
function law_and_justice_tb_team_carousel($atts, $content = null) {
	...
	wp_enqueue_script( 'custom-team-js', get_template_directory_uri() . '/js/custom/custom-team.js', array('jquery'), '20151215', true );
...
function law_and_justice_tb_client_carousel($atts, $content = null) {
	...
	wp_enqueue_script( 'custom-clients-js', get_template_directory_uri() . '/js/custom/custom-clients.js', array('jquery'), '20151215', true );
...
function law_and_justice_shortcode_counter($atts, $content = null) {
	...
	wp_enqueue_script( 'count-to-js', get_template_directory_uri() . '/vendor/count-to.js', array('jquery'), '20151215', true );
	wp_enqueue_script( 'custom-counters-js', get_template_directory_uri() . '/js/custom/custom-counters.js', array('jquery'), '20151215', true );
