	...
	$output .='<div class="row wedding-bio-wrapper">';		
		...
		$output .='<div class="col-sm-6">';
			...
			$output .='<div class="wedding-bio-item wedding-bio-item-bride">';
				...
				if (!empty($bride_image)) {	
					$output .='<figure class="wedding-bio-image"><img src="'. $bride_image_url.'" alt="Picture" class="responsive-image"></figure>';
				}
		...
		$output .='<div class="col-sm-6">';
			...
			$output .='<div class="wedding-bio-item wedding-bio-item-groom">';
				...
				if (!empty($groom_image)) {	
					$output .='<figure class="wedding-bio-image"><img src="'. $groom_image_url.'" alt="Picture" class="responsive-image"></figure>';
				}
