...
function bearr_team_carousel($atts, $content = null) {
	...
	if ( file_exists( get_template_directory() . '/framework/js/custom/custom-team.js' ) ) {
		wp_enqueue_script( 'bearr-custom-team-js', get_template_directory_uri() . '/framework/js/custom/custom-team.js', array('jquery'), '20151215', true );
	}
	else {
		wp_enqueue_script( 'bearr-custom-team-js', plugin_dir_url( __FILE__ ) . 'js/custom-team.js', array('jquery'), '20151215', true );
	}	
