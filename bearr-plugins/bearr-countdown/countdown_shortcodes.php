...
function bearr_countdown_item($atts, $content = null) {
	...
	wp_enqueue_script( 'countdown-js', plugin_dir_url( __FILE__ ) . 'js/vendor/jquery.countdown.min.js', array('jquery'), '20151218', true );
	wp_enqueue_script( 'bearr-countdown-custom-js', plugin_dir_url( __FILE__ ) . 'js/custom/bearr-countdown-custom-js.js', array('jquery'), '20151218', true );
