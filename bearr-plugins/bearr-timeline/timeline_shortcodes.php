...
function bearr_timeline_item_shortcode($atts, $text_content = null) {
	...
	$output .='">';		
		...
		$output .=' ">';
			...
			if (!empty($image)) {	
				$output .='<div class="story-item-img"><img src="'. $image_url.'" alt="Picture" class="responsive-image"></div>';
			}
	...
	//Matchheight JS
	wp_enqueue_script( 'bearr-matchheight-js', plugin_dir_url( __FILE__ ) . 'js/vendor/jquery.matchHeight-min.js', array('jquery'), '20151218', true );
